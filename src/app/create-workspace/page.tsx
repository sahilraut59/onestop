...
const Step1 = () => {
  ...
  return (
    <>
      ...
      />
      <Typography
        text="This will be the name of your OneStop workspace - choose something that your team will recognize"
...
const Step2 = () => {
  const { currStep, setCurrStep, updateImageUrl, imageUrl, name } =
  ...
  const handleSubmit = async () => {
    ...
    toast.success('Workspace create sucessfully.');
    router.push('/');
  };
  return (
    <>
